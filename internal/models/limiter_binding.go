...
const (
	...
	LimiterTargetAPIService  = "api_service"
	LimiterTargetAPIRoute    = "api_route"
	LimiterTargetAPIUpstream = "api_upstream"
)

func IsAPILimiterTarget(targetType string) bool {
	return targetType == LimiterTargetAPIService || targetType == LimiterTargetAPIRoute || targetType == LimiterTargetAPIUpstream
}
