...
type UsageLogTrace struct {
	...
	RequestID          string `gorm:"size:64;index:idx_trace_req_attempt,unique;index" json:"request_id"`
	AttemptIndex       int    `gorm:"index:idx_trace_req_attempt,unique" json:"attempt_index"`
