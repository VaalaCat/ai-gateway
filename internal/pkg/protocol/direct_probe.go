...
import wire "github.com/VaalaCat/ai-gateway/internal/pkg/tunnel"

type ProbePolicy = wire.ProbePolicy

const (
	ProbeRespectBusinessPolicy = wire.ProbeRespectBusinessPolicy
	ProbeBypassBusinessPolicy  = wire.ProbeBypassBusinessPolicy
)
