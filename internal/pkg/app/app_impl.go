...
type application struct {
	...
	masterSettings *MasterSettingsSnapshot
...
func NewApplication() Application {
	return &application{masterSettings: NewMasterSettingsSnapshot()}
}
...
func (a *application) GetMasterSettings() *MasterSettingsSnapshot { return a.masterSettings }
