...
export function SaveBar({ isDirty, dirtyFieldCount, saving, onSave, onCancel }: SaveBarProps) {
  ...
  return (
    <div className="sticky bottom-0 z-10 bg-background/95 backdrop-blur border-t px-4 py-3 flex flex-col-reverse md:flex-row md:items-center md:justify-between gap-3">
